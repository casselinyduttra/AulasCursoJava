/*
 *  02. Gerar e imprimir uma matriz M 10x10 com valores aleatórios entre 0-9. Após isso
...
class Exercicio02Matriz {

	public static void main(String[] args) {
		
		/*
		 * 02. gere e imprimir uma matriz 4 x4 com valores aleatorios
		 */
